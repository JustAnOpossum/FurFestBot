...
const db = new Datastore({ filename: path.join(__dirname, "../countdown.db"), autoload: true })
...
exports.add = function (uid, name, group) {
  return new Promise(function(res, rej){
    ...
    db.find({chatId:uid}, function (err, docs) {
        if (!err){
          if (docs[0] === undefined) {
...
exports.remove = function(id) {
  return new Promise(function(res, rej){
    db.remove({chatId:id}, function(err, num){
      if (!err){
        if (num != 1) {
          res('Not Here')
        }
